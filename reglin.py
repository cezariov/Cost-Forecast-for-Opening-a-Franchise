...
st.title('Previsão de Custos Para Abrir Franquia')

dados = pd.read_csv(r"C:\Users\vinic\OneDrive\Documentos\GitHub\Cost-Forecast-for-Opening-a-Franchise\slr12.csv",sep=";" )
